...
#energy_eV = 6.14e9
gaps = [10e-3, 10e-3]
real_central_s0 = 4.7e-3
assumed_central_s0 = 4.73e-3
delta_offsets_s0 = np.array([-0.05, 0, 0.05])*1e-3
beam_offsets_s0_real = [4.6e-3, 4.7e-3, 4.8e-3]
...
for beam_offset0 in beam_offsets_s0_real:
    ...
    meas_screen = tracker.elegant_forward(profile_meas, gaps, beam_offsets, n_bins)['screen']
