...
for n_offset, offset in enumerate(offset_arr[:-1]):
    ...
    tracker.wake2d = False
    tracker.split_streaker = 0
    forward_dict_old = tracker.matrix_forward(profile_meas, gaps, beam_offsets)
...
for centroid_arr, err, label in [(centroids, centroids_sig*1e3, 'Measured'), (centroids_sim, None, 'Simulated 1d'), (centroids_sim_new, None, 'Simulated 2d')]:
