...
for strength_label, meta_data, image, calib_image in [
    ...
    res_dicts = {}
    for quad_wake, label in [(False, 'Dipole'), (True, 'Quadrupole')]:
    ...
    resolution2 = beamsize / res_dicts['Dipole']['streaking_strength']
    time2 = res_dicts['Dipole']['time']

    sp_res.plot(time2*1e15, resolution2*1e15, label='Dipole 2')
