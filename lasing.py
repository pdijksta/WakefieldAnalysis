...
def obtain_lasing(image_off, image_on, n_slices, wake_x, wake_t, len_profile, dispersion, energy_eV, charge):
    ...
    for ctr, (image_obj, label) in enumerate([(image_off, 'Lasing_off'), (image_on, 'Lasing_on')]):
        ...
        all_images[label] = image_tE

    slice_time = all_slice_dict['Lasign_off']['slice_x']
    mean_current = (all_slice_dict['Lasign_off']['slice_current']+all_slice_dict['Lasign_on']['slice_mean'])/2.

    delta_E = all_slice_dict['Lasign_off']['slice_mean'] - all_slice_dict['Lasign_on']['slice_mean']
    delta_std_sq = all_slice_dict['Lasign_on']['slice_sigma']**2 - all_slice_dict['Lasign_off']['slice_sigma']**2
